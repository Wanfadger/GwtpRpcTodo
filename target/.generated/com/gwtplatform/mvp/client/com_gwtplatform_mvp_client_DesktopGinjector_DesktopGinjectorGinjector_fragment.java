...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
   ...
   *   com.wanfadger.gwtrpcdemo.client.gin.ClientModule.configure(ClientModule.java:26)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.wanfadger.gwtrpcdemo.client.gin.ClientModule.configure(ClientModule.java:27)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.wanfadger.gwtrpcdemo.client.gin.ClientModule.configure(ClientModule.java:28)
   */
